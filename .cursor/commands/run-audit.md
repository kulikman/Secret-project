---
description: Run audit — полный аудит Тайное Бюро, при необходимости обновляет rules.json
---

Выполни полный аудит репозитория **Тайное Бюро** строго по инструкции в `audit/AUDIT_PROMPT.md`.
