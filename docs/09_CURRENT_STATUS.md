...
- [x] Awakening Map SVG nodes with existing public routes open their card directly from the atlas
- [x] Topic cards include an explicit Perplexity live-research panel; generated text is not stored as projection content
